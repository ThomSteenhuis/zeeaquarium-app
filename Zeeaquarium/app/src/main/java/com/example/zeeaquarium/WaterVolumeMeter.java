...
public class WaterVolumeMeter implements IMeter {
    private static final String NAME = "watervolume";
    ...
    public WaterVolumeMeter(Speedometer meter, Activity activity) {
        this.meter = meter;
