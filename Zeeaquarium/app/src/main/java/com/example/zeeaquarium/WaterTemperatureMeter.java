...
public class WaterTemperatureMeter implements IMeter {
    private static final String NAME = "watertemperature";
    ...
    public WaterTemperatureMeter(Speedometer meter, Activity activity) {
        this.meter = meter;
