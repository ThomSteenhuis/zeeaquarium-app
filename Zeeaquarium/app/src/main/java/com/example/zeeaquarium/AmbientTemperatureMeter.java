...
public class AmbientTemperatureMeter implements IMeter {
    private static final String NAME = "ambienttemperature";
    ...
    public AmbientTemperatureMeter(Speedometer meter, Activity activity) {
        this.meter = meter;
    ...
    public void setGrayoutColoring() {
        ...
        meter.getSections().get(3).setColor(Color.rgb(130, 130, 130));
        meter.getSections().get(4).setColor(Color.rgb(100, 100, 100));
    }
    ...
    public void setDefaultColoring() {
        ...
        meter.getSections().get(3).setColor(Color.YELLOW);
        meter.getSections().get(4).setColor(Color.RED);
    }
