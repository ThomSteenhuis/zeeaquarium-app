...
public class DosingPumpWeightMeter implements IMeter {
    private String name;
    private Speedometer meter;
    private Activity activity;
    private Measurement value = new Measurement(this.name, "");

    private BehaviorSubject<Measurement> valueSubject = BehaviorSubject.create();

    public DosingPumpWeightMeter(String name, Speedometer meter, Activity activity) {
        this.name = name;
        this.meter = meter;
    ...
    public void setValue(Measurement value) {
        if (value.getName().equals(this.name)) {
